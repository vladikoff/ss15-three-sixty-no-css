...
loadInitializers(App, config.modulePrefix);
  ...
  //   // _engine.render.canvas.width = window.innerWidth;
  //   // _engine.render.canvas.height = window.innerHeight;
  ...
  //   var stack = Composites.stack(10, 10, 15, 4, 0, 0, function(x, y, column, row) {
